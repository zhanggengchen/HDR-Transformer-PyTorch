...
from .lsq_utils.lsq import ActOurs, Conv2dOurs, ConvTranspose2dOurs

class SpatialAttentionModule(nn.Module):

    def __init__(self, dim, nbits_w, nbits_a):
        super(SpatialAttentionModule, self).__init__()
        self.att1 = Conv2dOurs(dim * 2, dim * 2, kernel_size=3, padding=1, bias=True, nbits_w=nbits_w, nbits_a=nbits_a)
...
class SIDUNet(nn.Module):
    def __init__(self, inchannels=6, outchannels=3, channels=64, nbits_w=4, nbits_a=4) -> None:
        ...
        self.conv_first = Conv2dOurs(channels * 3, channels, kernel_size=3, stride=1, padding=1, nbits_w=nbits_w, nbits_a=nbits_a)
        ...
        self.conv6_1 = Conv2dOurs(channels * 16, channels * 8, kernel_size=3, stride=1, padding=1, nbits_w=nbits_w, nbits_a=nbits_a)
        ...
        self.conv7_1 = Conv2dOurs(channels * 8, channels * 4, kernel_size=3, stride=1, padding=1, nbits_w=nbits_w, nbits_a=nbits_a)
        ...
        self.conv8_1 = Conv2dOurs(channels * 4, channels * 2, kernel_size=3, stride=1, padding=1, nbits_w=nbits_w, nbits_a=nbits_a)
        ...
        self.conv9_1 = Conv2dOurs(channels * 2, channels, kernel_size=3, stride=1, padding=1, nbits_w=nbits_w, nbits_a=nbits_a)
