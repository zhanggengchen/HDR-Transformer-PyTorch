...
def get_args():
    parser = argparse.ArgumentParser(description='SwinIR-HDR',
    ...
    parser.add_argument("--sub_set", type=str, default='sig17_training_crop128_stride64',
                        help='dataset directory')
    parser.add_argument('--logdir', type=str, default='./experiment/SwinIR',
...
def main():
    ...
    # model architectures
    model = SwinIR(embed_dim=60, depths=[6, 6, 6], num_heads=[6, 6, 6], mlp_ratio=2, in_chans=6)
    cur_psnr = [-1.0]
    # init
