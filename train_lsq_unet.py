...
def get_args():
    ...
    parser.add_argument("--sub_set", type=str, default='sig17_training_crop128_stride64',
                        help='dataset directory')
    parser.add_argument('--logdir', type=str, default='./experiment/SIDUNet_lsq',
...
# CUDA_VISIBLE_DEVICES=0,1 python train_lsq_unet.py --pretrained experiment/SIDUNet/best_checkpoint.pth --nbits_w 2 --nbits_a 2